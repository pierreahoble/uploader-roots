                ...
                <input type="hidden" name="id" value=" {{$user->id}} ">
                        <div class="row mb-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="name" id="exampleInputEmail1" class="form-control" required value="{{$user->name }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="email" name="email" id="exampleInputEmail12" class="form-control" required value="{{$user->email }}">
